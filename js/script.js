...
async function sendData() {
    ...
    let response = await fetch(`https://api.edamam.com/search?app_id=${secretKey}&app_key=${MY_ID}&q=${searchOutput}&from=0&to=25`);
...
function getCard(cardData) {
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Calories: ${cardData.recipe.calories}</p><p><strong>Health Labels:</strong> ${cardData.recipe.healthLabels}</p>
